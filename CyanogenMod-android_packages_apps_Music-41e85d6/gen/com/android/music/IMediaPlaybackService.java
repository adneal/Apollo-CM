 ...
 * Original file: C:\\Users\\Andrew\\Desktop\\CyanogenMod-android_packages_apps_Music-41e85d6\\src\\com\\android\\music\\IMediaPlaybackService.aidl
 */
...
case TRANSACTION_toggleShuffle:
{
data.enforceInterface(DESCRIPTOR);
this.toggleShuffle();
reply.writeNoException();
...
case TRANSACTION_getAlbumartistName:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _result = this.getAlbumartistName();
reply.writeNoException();
reply.writeString(_result);
return true;
}
case TRANSACTION_getAlbumartistId:
{
data.enforceInterface(DESCRIPTOR);
long _result = this.getAlbumartistId();
reply.writeNoException();
reply.writeLong(_result);
return true;
}
...
public void cycleRepeat() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_cycleRepeat, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
public void toggleShuffle() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_toggleShuffle, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
public java.lang.String getAlbumartistName() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getAlbumartistName, _data, _reply, 0);
_reply.readException();
_result = _reply.readString();
}
finally {
...
public long getAlbumartistId() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
long _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getAlbumartistId, _data, _reply, 0);
_reply.readException();
_result = _reply.readLong();
}
finally {
...
static final int TRANSACTION_cycleRepeat = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_toggleShuffle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
...
static final int TRANSACTION_getAlbumartistName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getAlbumartistId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
