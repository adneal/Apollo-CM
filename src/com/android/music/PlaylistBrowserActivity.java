...
public class PlaylistBrowserActivity extends ListActivity implements
	...
	// Artist tab layout
	public LinearLayout mPlaylistTab;
	...
	public void onCreate(Bundle icicle) {
		...
		if (themeResources != null) {
			// Artist tab
			mPlaylistTab = (LinearLayout) findViewById(R.id.album_tab);
			...
			if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
				...
				ArtistAlbumBrowserActivity.loadThemeResource(themeResources,
						themePackage, "snp_plus_playlist", mPlusPlaylist,
						THEME_ITEM_FOREGROUND);
			}
		}
	}
		...
		public void bindView(View view, Context context, Cursor cursor) {
			...
			if (themeResources != null) {
				...
				int line1 = themeResources.getIdentifier(
						"playlist_tab_playlist_name_color", "color",
						themePackage);
				if (line1 != 0) {
